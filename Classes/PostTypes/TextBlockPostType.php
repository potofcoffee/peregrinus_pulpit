 ...
 */
class TextBlockPostType extends AbstractPostType
{

    public function __construct()
    {
        $this->labels = [
            'name' => __('Text blocks', 'pulpit'),
            'singular_name' => __('Text block', 'pulpit'),
            'add_new' => _x('Add New', 'pulpit_textblock', 'pulpit'),
            'add_new_item' => __('Add New Text Block', 'pulpit'),
            'edit_item' => __('Edit Text Block', 'pulpit'),
            'new_item' => __('New Text Block', 'pulpit'),
            'view_item' => __('View Text Block', 'pulpit'),
            'search_items' => __('Search Text Blocks', 'pulpit'),
            'not_found' => __('No text blocks found', 'pulpit'),
            'not_found_in_trash' => __('No text blocks found in Trash', 'pulpit'),
            'menu_name' => __('Text Blocks', 'pulpit'),
        ];
